...
5.  Create the file `detail-charts-views.js` in the `/config/www/` folder.
6.  IMPORTANT, insert the code into your `configuration.yaml` as explained in Method 1 and restart Home Assistant.
